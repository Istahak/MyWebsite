const achievementDetails = {
  ...
  highlights: [
    "Secured 8th position in a competitive field",
    "Successfully solved majority of the problem set",
    "Demonstrated strong problem-solving fundamentals",
    "Identified critical areas for improvement in our preparation",
    "Gained valuable experience in handling setbacks during competition",
  ],
  challenges: [
    "Encountered a critical bug in our Suffix Array template implementation",
    "Lost valuable time debugging a template we assumed was correct",
    "Managed frustration and maintained focus despite the setback",
    "Made difficult decisions about when to abandon and when to persist",
    "Dealt with the emotional impact of a preventable mistake",
  ],
