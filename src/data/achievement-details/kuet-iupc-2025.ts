export default {
  ...
  highlights: [
    "Achieved 20th position among numerous talented teams from across Bangladesh",
    "Successfully tackled problems involving diverse algorithmic concepts",
    "Maintained team synergy and effective communication throughout the contest",
    "Applied lessons learned from previous competitions to improve strategy",
    "Demonstrated consistent growth in competitive programming skills",
  ],
  challenges: [
    "Competitive field with many strong and experienced teams",
    "Problems requiring deep understanding of advanced data structures",
    "Time pressure forcing quick decision-making on problem selection",
    "Debugging under strict time constraints",
    "Balancing between solving simpler problems quickly versus attempting harder ones",
  ],
