const achievementDetails = {
  ...
  highlights: [
    "Secured 9th position in the prestigious Samsung Code Contest onsite round",
    "Competed in an industry-sponsored competition with real-world relevance",
    "Solved problems designed to reflect industry coding challenges",
    "Networked with talented programmers and Samsung R&D professionals",
    "Gained insights into what leading tech companies look for in programmers",
    "Demonstrated individual problem-solving capabilities in a solo competition format",
  ],
  challenges: [
    "Adapting to industry-style problems different from typical ICPC format",
    "Managing time effectively across problems with varying difficulty levels",
    "Competing individually without the support of a team",
    "Handling the pressure of performing for potential career opportunities",
    "Balancing between perfect solutions and pragmatic, time-efficient approaches",
  ],
  problemsAttempted: 8,
  problemsSolved: 6,
  contestDuration: "4 hours",
  reflection:
